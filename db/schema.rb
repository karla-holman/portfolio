...
ActiveRecord::Schema.define(version: 20170502173925) do
  ...
  create_table "sale_car_images", force: :cascade do |t|
    t.integer  "sale_car_id"
    t.text     "description"
    t.datetime "created_at",              null: false
    t.datetime "updated_at",              null: false
    t.string   "attachment_file_name"
  ...
  create_table "spree_excels", force: :cascade do |t|
    t.string   "name"
  ...
  create_table "spree_orders", force: :cascade do |t|
    ...
    t.boolean  "in_quickbooks",                                              default: false
  end
